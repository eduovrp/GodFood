            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="../adicionais">Adicionais</a></li>
...
$adicional = mostraDadosAdicional($_POST['id_adicional']);
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                       <div class="input-group">
                           <div class="row">
                               <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                  ...
                                  if($categoria['id_categoria'] == $adicional['id_categoria']){ 
                          ...
                          <br>
                        <div align="right">
                          <input type="hidden" name="alterarDadosAdicional" value="alterar">
                            <a href="../adicionais" type="button" class="btn btn-default btn-lg btn-outline"><i class="fa fa-arrow-left fa-1x"></i> Voltar</a>
                            &nbsp;&nbsp;
