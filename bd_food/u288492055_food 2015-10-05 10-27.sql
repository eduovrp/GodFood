...
--
-- Host: 127.0.0.1
-- Generation Time: 05-Out-2015 às 15:27
...
CREATE TABLE IF NOT EXISTS `categorias` (
  ...
  `2sabores` char(3) CHARACTER SET latin1 DEFAULT 'Não',
...
CREATE TABLE IF NOT EXISTS `configs` (
  ...
  `id_restaurante` int(11) NOT NULL,
  `conf_borda` char(1) CHARACTER SET latin1 DEFAULT '0',
  `conf_adic` char(1) CHARACTER SET latin1 DEFAULT '0',
  `conf_2sabores` char(1) CHARACTER SET latin1 DEFAULT '0',
  PRIMARY KEY (`id_config`),
  KEY `fk_config_restaurante` (`id_restaurante`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7 ;
...
INSERT INTO `configs` (`id_config`, `id_restaurante`, `conf_borda`, `conf_adic`, `conf_2sabores`) VALUES
(1, 10, '1', '1', '1'),
(2, 5, '1', '1', '1'),
(3, 6, '0', '0', '0'),
(4, 7, '0', '0', '0'),
...
(26, 'Rua Teste', '11', 'morumbi', '', '', 'sp', 'são paulo', '05010-000', 64);
...
INSERT INTO `itens_pedido` (`id_item_pedido`, `id_pedido`, `id_categoria`, `produto`, `qtd`, `id_adicional`, `adicional`, `id_borda`, `borda`, `obs`, `valor_unit`) VALUES
(165, 101, 12, 'Brigadeiro', 1, NULL, 'Nenhum', NULL, 'Não', NULL, '25.50'),
(166, 101, 11, '1/2 Americana / 1/2 Calabresa', 1, NULL, 'Nenhum', NULL, 'Não', NULL, '22.50'),
(167, 102, 11, 'Americana', 1, 20, 'Catupiry', 14, 'Goiabada', NULL, '30.50'),
(168, 102, 11, 'Calabresa', 1, 20, 'Catupiry', 14, 'Goiabada', NULL, '29.00'),
(169, 102, 11, '1/2 Frango Especial / 1/2 Aliche', 1, 20, 'Catupiry', 12, 'Cheddar', NULL, '38.00'),
(170, 103, 11, 'Americana', 1, 21, 'Cheddar', 11, 'Catupiry', NULL, '31.00'),
(171, 104, 11, 'Americana', 1, 20, 'Catupiry', NULL, 'Não', NULL, '26.50'),
(172, 105, 11, 'Americana', 1, 21, 'Cheddar', 11, 'Catupiry', NULL, '31.00'),
(173, 106, 11, 'Americana', 1, NULL, 'Nenhum', NULL, 'Não', NULL, '22.50'),
(174, 107, 12, 'Brigadeiro', 1, NULL, 'Nenhum', NULL, 'Não', NULL, '25.50'),
(175, 108, 11, 'Aliche', 1, NULL, 'Nenhum', NULL, 'Não', NULL, '26.00'),
(176, 109, 11, '1/2 Americana / 1/2 Calabresa', 1, 20, 'Catupiry', 14, 'Goiabada', NULL, '30.50');
...
INSERT INTO `pedidos` (`id_pedido`, `data`, `timestamp`, `valor_total`, `valor_pago`, `taxa_entrega`, `id_usuario`, `id_restaurante`, `id_status`, `id_cidade_entrega`, `endereco`, `data_pgto`, `data_confirm`, `data_delivery`, `data_entrega`, `data_error`) VALUES
(101, '2015-07-05 15:18:30', NULL, '48.00', '50.90', '0.00', 41, 5, 7, 1, 'Av. Navarro de Andrade, 347 - Centro / Santa Fé do Sul - SP', '2015-07-05 15:30:48', '2015-07-05 15:55:19', '2015-07-05 15:55:23', '2015-07-05 15:55:25', NULL),
(102, '2015-07-06 16:44:39', NULL, '97.50', '100.40', '0.00', 41, 5, 7, 1, 'Av. Navarro de Andrade, 347 - Centro / Santa Fé do Sul - SP', '2015-07-06 16:44:59', '2015-07-06 16:45:25', '2015-07-06 16:45:27', '2015-07-06 16:45:29', NULL),
(103, '2015-07-14 00:23:52', NULL, '31.00', '31.00', NULL, 41, 5, 7, 1, 'Av. Navarro de Andrade, 347 - Centro / Santa Fé do Sul - SP', '2015-07-14 00:23:53', '2015-07-16 18:56:49', '2015-07-16 18:57:00', '2015-07-16 18:57:01', NULL),
(104, '2015-07-14 00:27:17', NULL, '26.50', '29.40', '0.00', 41, 5, 7, 1, 'Av. Navarro de Andrade, 347 - Centro / Santa Fé do Sul - SP', '2015-07-14 00:27:17', '2015-07-16 18:56:51', '2015-07-16 18:57:03', '2015-07-16 18:57:05', NULL),
(105, '2015-07-14 00:31:02', NULL, '31.00', '33.90', '0.00', 41, 5, 7, 1, 'Av. Navarro de Andrade, 347 - Centro / Santa Fé do Sul - SP', '2015-07-14 00:31:02', '2015-07-16 18:56:53', '2015-07-16 18:57:07', '2015-07-16 18:57:09', NULL),
(106, '2015-07-16 13:56:04', 1437054964, '22.50', '25.40', '0.00', 41, 5, 7, 1, 'Av. Navarro de Andrade, 347 - Centro / Santa Fé do Sul - SP', '2015-07-16 13:56:34', '2015-07-16 18:56:55', '2015-07-16 18:57:11', '2015-07-16 18:57:12', NULL),
(107, '2015-07-16 13:58:59', 1437055139, '25.50', '28.40', '0.00', 41, 5, 7, 1, 'Av. Navarro de Andrade, 347 - Centro / Santa Fé do Sul - SP', '2015-07-16 13:59:29', '2015-07-16 18:56:57', '2015-07-16 18:57:15', '2015-07-16 18:57:18', NULL),
(108, '2015-07-17 17:20:21', NULL, '26.00', '28.90', '0.00', 41, 5, 7, 1, 'Av. Navarro de Andrade, 347 - Centro / Santa Fé do Sul - SP', '2015-07-17 17:20:51', '2015-07-20 12:52:21', '2015-07-20 12:52:26', '2015-07-20 12:52:27', NULL),
(109, '2015-07-17 17:23:16', NULL, '30.50', '30.50', '0.00', 41, 5, 7, 1, 'Av. Navarro de Andrade, 347 - Centro / Santa Fé do Sul - SP', '2015-07-17 17:23:46', '2015-07-20 12:52:24', '2015-07-20 12:52:29', '2015-07-20 12:52:31', NULL);
...
CREATE TABLE IF NOT EXISTS `restaurantes` (
  ...
  `taxa_paypal` decimal(6,2) NOT NULL DEFAULT '4.99',
  `taxa_adm` decimal(6,2) NOT NULL DEFAULT '10.00',
...
(5, 'Pizzaria', '40 min', 'Restaurante de Teste 1', '15.785.215/1881-85', '(17) - 3631-2313', 'Restaurante de Teste 1', 'Aberto', 'Av. Navarro de Andrade', '1188', 'Centro', 'Santa Fé do Sul - SP', 1, '18:00:00', '23:30:00', '10.00', '1.95', '6.40', '10.00'),
...
(10, 'Japonesa', '55 min', 'Restaurante de Teste 6', '49.846.846/4684-61', '(15) - 1518-1484', 'Restaurante de Teste 6', 'Fechado', 'Rua dos Testes', '442', 'Centro', 'Santa Fé do Sul - SP', 0, '18:00:00', '23:00:00', '25.00', '2.90', '6.40', '6.50');
...
CREATE TABLE IF NOT EXISTS `tarifas` (
  ...
  `taxa_paypal_porc` decimal(6,2) NOT NULL DEFAULT '4.99',
  `taxa_paypal_60` decimal(6,2) NOT NULL DEFAULT '0.70',
  `taxa_adm` decimal(6,2) NOT NULL,
...
(107, 5, 101, '2015-07-05 15:30:48', '50.90', '48.00', '40.01', '7.03', '7.99', '3.86', '10.89', 1, '6.40', '0.60', '9.00'),
(108, 5, 102, '2015-07-06 16:45:00', '100.40', '97.50', '81.89', '11.49', '15.62', '7.03', '18.52', 1, '6.40', '0.60', '9.00'),
(109, 5, 103, '2015-07-13 19:23:53', '31.00', '31.00', '25.63', '2.79', '5.37', '2.58', '5.37', 1, '6.40', '0.60', '9.00'),
(110, 5, 104, '2015-07-13 19:27:17', '29.40', '26.50', '21.82', '5.10', '4.68', '2.48', '7.58', 1, '6.40', '0.60', '9.00'),
(111, 5, 105, '2015-07-13 19:31:02', '33.90', '31.00', '25.63', '5.50', '5.37', '2.77', '8.27', 1, '6.40', '0.60', '9.00'),
(112, 5, 106, '2015-07-16 13:56:04', '25.40', '22.50', '18.44', '4.74', '4.07', '2.23', '6.97', 0, '6.40', '0.60', '9.00'),
(113, 5, 107, '2015-07-16 13:58:59', '28.40', '25.50', '20.97', '5.01', '4.53', '2.42', '7.43', 0, '6.40', '0.60', '9.00'),
(114, 5, 108, '2015-07-17 17:20:21', '28.90', '26.00', '21.40', '5.05', '4.60', '2.45', '7.50', 0, '6.40', '0.60', '9.00'),
(115, 5, 109, '2015-07-17 17:23:16', '30.50', '30.50', '25.20', '2.75', '5.30', '2.55', '5.30', 0, '6.40', '0.60', '9.00');
...
INSERT INTO `usuarios` (`id_usuario`, `login`, `alcunha`, `senha`, `email`, `nome`, `cpf`, `telefone`, `celular`, `id_nivel`, `usr_ativo`, `hash_ativar_conta`, `senha_reset_hash`, `senha_reset_timestamp`, `rememberme_token`, `failed_login`, `last_failed_login`, `data_registro`, `ip_registro`) VALUES
(2, 'admin', 'admin', 'aa382912594903549b16f6c6aeef58020972330df8183ccadc6b267c5efee6b7b3260ec020e9e3a5140bfcd9d61ebdbdc152b6c0a41173b704e7f74ed99a1ffc', 'teste@gmail.com', 'Eduardo Lopes', '000.000.000-00', '', '', 5, 1, NULL, NULL, NULL, NULL, 0, NULL, '2015-04-15 14:46:18', '127.0.0.1'),
(8, 'eduovrp1', 'eduovrp1', '4817714bd05c0ea638e51189e367f0bb03085d221d6d3f1eaf8ba465819535a3321444fbf994896929a8b79f0991025b970f70d597049d425a27176d8994896a', 'admin@godfood.com.br', 'Admin', '111.111.111-11', '', '', 5, 1, NULL, NULL, NULL, NULL, 0, NULL, '2015-05-22 12:36:21', '127.0.0.1'),
(25, 'marcosfs', 'marcosfs', '74356d9220a841e320651007e509399ebf389fee5a817df9192f47dbacf1d1f7a10063a364f61c39b3c9807ec17970c882cc9eec098c20834933195fd3a6b599', 'marcosfernando7@gmail.com', 'Marcos Fernando', '777.777.777-77', '', '(17) - 99609-8049', 1, 1, NULL, NULL, NULL, NULL, 0, NULL, '2015-06-03 15:14:03', '186.225.145.106'),
(34, 'teste', 'teste', 'aa382912594903549b16f6c6aeef58020972330df8183ccadc6b267c5efee6b7b3260ec020e9e3a5140bfcd9d61ebdbdc152b6c0a41173b704e7f74ed99a1ffc', 'eduovrp@godfood.com.br', 'Eduardo Lopes', '222.222.222-22', '', '(17) - 99764-0291', 1, 1, NULL, NULL, NULL, NULL, 0, NULL, '2015-06-04 17:01:51', '187.10.35.158'),
(38, 'jrsimensato', 'jrsimensato', '50e61808ed28c0b0be9ada99c3e0b51e0d30aecccd823472a1ec9f1aec87c0ed70188cf3d5c314f8f2855a4f17fac56908584af2e9688f6a99a1f16ebd9763ae', 'juniorsimensato@outlook.com', 'onivaldo simensato junior', '400.219.628-39', '(17) - 3442-5882', '(17) - 99625-4065', 1, 1, NULL, NULL, NULL, NULL, 0, NULL, '2015-08-06 15:18:34', '177.234.146.154'),
(40, 'joilso', 'joilso', '507b1d0a3252b0f2f1ed99b3ae07c4538009991dd708aa8a094614ce4892cad5d6ba349514773dc20589e875aa992ebb516d8a56d39fb1dbafbb5d210f28b1f0', 'joilsomen@hotmail.com', 'Joilso Meira Novais', '039.000.801-00', '(17) - 3641-2099', '(17) - 99109-2211', 1, 1, NULL, NULL, NULL, NULL, 0, NULL, '2015-06-09 23:49:20', '177.234.146.154'),
(41, 'eduovrp', 'Supremo Sr Do Universo', 'aa382912594903549b16f6c6aeef58020972330df8183ccadc6b267c5efee6b7b3260ec020e9e3a5140bfcd9d61ebdbdc152b6c0a41173b704e7f74ed99a1ffc', 'eduovrp@gmail.com', 'Eduardo Lopes', '367.584.768-39', '', '(17) - 99764-0291', 5, 1, NULL, NULL, '2015-06-10 22:19:51', NULL, 0, NULL, '2015-06-10 00:09:58', '177.234.146.154'),
(42, 'le_yee', 'le_yee', '8e6d54edb1c1fd0b83a2d631ce21e71a81585780da28203a581fde1a1acbf64efe3c85e3047d53c6d82d924e27e07c40f4875dab5c3db44f8efab29fba12286a', 'leticinha_donatoni@hotmail.com', 'Letícia Donatoni Marim', '368.782.268-05', '(17) - 3691-1283', '(17) - 99702-2833', 1, 1, NULL, NULL, NULL, NULL, 0, NULL, '2015-06-10 18:28:32', '177.234.146.154'),
(43, 'nathalia', 'nathalia', '42da7425fa9c6ad72042a2dea2c762578f74bedd84424ae41df27e6967e9c99e5867bf69d23d58089f3a101670111df6d0d9fcee8341dd35e973264db824babe', 'nathalia.esteves1996@hotmail.com', 'Nathalia Silva Esteves', '456.825.288-16', '(17) - 3631-0841', '(17) - 99604-2539', 1, 0, 'daf10525e2bf19f3ba25fdf1efb1d41943f95e45', NULL, NULL, NULL, 0, NULL, '2015-06-10 18:50:15', '177.234.146.154'),
(44, 'guiilopes', 'guiilopes', 'b6f255c0d564ff7ba293811b13c0f8028928c43f67842696567b44d7067322fd6c608fe1b36999a0c0a09a63ebe1ab80d19e37cde9ed201ce770439a1b73186c', 'guii-lopes@hotmail.com', 'GUILHERME LOPES', '394.742.068-48', '', '(17) - 99151-4510', 1, 1, NULL, NULL, NULL, NULL, 0, NULL, '2015-06-18 20:27:33', '187.10.35.8'),
(45, 'math', 'math', '232ba70f52d7e8d1eb0b16e284d111748755480bb99c1d3cd6a856458f13f457ae18170aa33505619390f85638f618708efdc08fe6e636a1400ec2a843c54346', 'matheus.sfs95@gmail.com', 'Matheus Augusto Santana da Silva', '455.621.928-02', '', '(17) - 99623-9953', 5, 1, NULL, NULL, NULL, NULL, 0, NULL, '2015-06-24 04:51:16', '201.93.18.103'),
(47, 'teste5', 'teste5', '176b9dd7906dd9919b94aa17686d282628daee473bfe3576677959e87a8320d4f15c33fc5e1a98be9d44d789b828164ee748706b7c758db58d706cdb6cea692c', 'eduovrp@hotmail.com', 'Teste5', '018.548.028-44', '', '(17) - 99764-0291', 1, 1, NULL, '4a52bd55e5ac5926d63a1c5be7f3eb1f3c332b87', '2015-06-30 16:54:04', NULL, 0, NULL, '2015-06-24 11:23:51', '187.11.172.251'),
(64, 'filipedeschamps', 'filipedeschamps', '12e40f3104eadbd2bbf50c9c259113c20082547cae8ad6541708b757483e40a6d95ec814fe5e046fb4c5b8468b5ebf0aa3e17c742e42b98f928a23b4e2b4cc71', 'filipe.deschamps@pagar.me', 'Filipe Deschamps', '048.311.219-40', '(11) - 9529-1160', '(11) - 95291-1609', 1, 1, NULL, NULL, NULL, NULL, 0, NULL, '2015-07-17 16:39:33', '189.8.94.42'),
(65, 'wteodoro', 'wteodoro', '176b9dd7906dd9919b94aa17686d282628daee473bfe3576677959e87a8320d4f15c33fc5e1a98be9d44d789b828164ee748706b7c758db58d706cdb6cea692c', 'welingtonteodoro@hotmail.com', 'Welington Teodoro Lemos', '387.077.958-66', '(17) - 3691-1439', '(19) - 99854-1462', 5, 1, NULL, NULL, NULL, NULL, 0, NULL, '2015-10-02 04:17:02', '187.57.79.169');
...
--
ALTER TABLE `configs`
  ADD CONSTRAINT `fk_config_restaurante` FOREIGN KEY (`id_restaurante`) REFERENCES `restaurantes` (`id_restaurante`);
