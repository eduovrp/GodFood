...
<html>
	<head>
		...
		<script type='text/javascript'>var s=document.createElement('script');s.type='text/javascript';var v=parseInt(Math.random()*1000000);s.src='https://go.gerencianet.com.br/api/cdn/406276003/'+v;s.async=false;s.id=406276003;if(!document.getElementById('406276003')){document.getElementsByTagName('head')[0].appendChild(s);}function initGnCompiler(gnfn){if(typeof gnfn==='function'){gnfn();}};</script>
	</head>
	<body>
<?php 
...
?>
				...
				<div class="checkout-user-form">
						...
						<table class="table ">
							<tr class="text-bold text-center">
								<td class="column">Nome do Produto</td>
								<td class="column">Quantidade</td>
								<td class="column">Valor</td>
								<td class="column">Adicionais</td>
							</tr>
						<?php 
						$total = 0;
						...
						?>
							<tr class="text-center">
								<td class="column"><?=$cart_itm['name']." ( ".$categoria['nome'].")";?></td>
								<td class="column"><?=$cart_itm["qtd"]?></td>
								<td class="column">R$ <?=number_format($valorTotalProduto,2,",",".");?></td>
								<td class="column">Adicional : <?=$cart_itm['adicional'];?> / Borda Recheada : <?=$cart_itm['borda'];?></td>
							</tr>
						<?php endforeach; ?>
						</table>
						<input type="hidden" id='total' value="<?=$total * 100;?>" data-gn-total />
						<input type="hidden" name="frete" value="<?=1.90 * 100;?>" />
				</div>
						...
						<div class="checkout-info-user">
							<div class="clear">
								...
								<div class="checkout-column-2 pull-left">
									...
									<div class="checkout-input-div checkout-grand-input">
										<input type="text" class="checkout-input-text checkout-grand-input" name="cliente-email" id="cliente-email" value="<?=$_SESSION['email'];?>" onblur="verifyEmail(this)" data-gn-cliente-email />
									</div>
								</div>
							</div>
							<div class="clear checkout-line">
		...
		<?php
				...
				header("Location: esolha_produtos.php");
			}
