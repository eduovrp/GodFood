...
$PayPalReturnURL 		= 'https://godfood.com.br/cart/process.php'; //Point to process.php page
$PayPalCancelURL 		= 'https://godfood.com.br/cart/cancel_url.php'; //Cancel URL if user clicks cancel
