...
$PayPalReturnURL 		= 'http://localhost/GodFood/cart/process.php'; //Point to process.php page
$PayPalCancelURL 		= 'http://localhost/GodFood/cart/cancel_url.php'; //Cancel URL if user clicks cancel
