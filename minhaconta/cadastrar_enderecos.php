					...
					<div class="col-md-5">
					 ...
					 <div class="col-md-6">
					   <a class="news-letter" href="#">
						 <label class="checkbox"><input type="checkbox" name="checkbox" checked="" required><i> </i>Concordo com os <a href="../termos.php" target="_blank" class="termos-a"> Termos de Entrega</a></label>
					   </a>
					 </div>
					 </div>
